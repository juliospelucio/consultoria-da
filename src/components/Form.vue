<template>
  ...
  >
    ...
    <p class="md:text-xl leading-none my-6">
    ...
    <form>
      ...
      <div class="text-center">
        <button class="btn btn-yellow p-4 mt-2">Enviar</button>
      </div>
    </form>
  </div>
</template>
...
<style scoped>
.form {
  @apply bg-blue-900 text-white p-8;
}
.btn {
  @apply font-bold py-2 px-8 rounded-full;
}
.btn-yellow {
